...
@interface RCTYdPlatelineView : UIView <UIGestureRecognizerDelegate> {
...
//板块异动数据
@property (nonatomic,strong) NSArray *changeData;//异动数组
@property (nonatomic,strong) NSString * plateData;//异动数据
